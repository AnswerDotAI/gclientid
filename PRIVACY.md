...
stored locally; users can remove that data directly from their computer.

Use of information received from Google APIs adheres to the [Google API
Services User Data Policy](https://developers.google.com/terms/api-services-user-data-policy),
including its Limited Use requirements.

Questions or concerns can be raised through the project's [public issue
tracker](https://github.com/AnswerDotAI/gclientid/issues).
